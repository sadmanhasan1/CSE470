...
public class ChefRegistration extends AppCompatActivity {
    ...
    String[] Dhaka = {"Bailey Road","Banani ","Banasree","Baridhara","Bashundhara Residential Area"};
    String[] Chittagong = {"Akbar Shah","Bakalia","Chandgaon","Chittagong Kotwali","Patenga","Pahartali"};
